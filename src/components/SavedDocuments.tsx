...
import {
  FolderHeart, FileText, Trash2, ArrowRight, ShieldCheck, Clock, Layers,
...
export const SavedDocuments: React.FC = () => {
  ...
  const handleOpenDoc = (docId: string) => {
    // Select first, then navigate. Without the select, the reader renders
    // whichever analysis happened to be active and every card appeared to open
    // the same document. The destination is the redesign's dedicated analysis
    // page rather than the home reader.
